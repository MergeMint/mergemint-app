...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pathPriorities: Record<string, { priority: number; changeFrequency: 'weekly' | 'monthly' | 'yearly' }> = {
    ...
    'mergemint-vs-linearb': { priority: 0.8, changeFrequency: 'monthly' },
    'mergemint-vs-jellyfish': { priority: 0.8, changeFrequency: 'monthly' },
    'mergemint-vs-gitclear': { priority: 0.8, changeFrequency: 'monthly' },
    alternatives: { priority: 0.8, changeFrequency: 'monthly' },
    'best-linearb-alternatives': { priority: 0.8, changeFrequency: 'monthly' },
    'best-jellyfish-alternatives': { priority: 0.8, changeFrequency: 'monthly' },
